import { EncryptionAlgorithm, ZKOperator } from '../index';
...
type ConfigItem = 'snarkjs' | 'gnark' | 'expander-single-thread' | 'expander-multi-thread';
export declare function getEngineForConfigItem(item: ConfigItem): "snarkjs" | "gnark" | "expander";
