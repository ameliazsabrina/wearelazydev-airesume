...
export async function generatePDFFromResume(resumeData, outputFilePath = null) {
    let browser = null;
    try {
        ...
        const rawResumeText = resumeData.resumeText || "No resume content available";
        const cleanedResumeText = rawResumeText.replace(/^```markdown\n|\n```$/g, "");
